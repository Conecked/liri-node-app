...
function songInfo() {
    ...
    spotify.search({
            ...
            jsonData = data.tracks.items[0];
            var songData = [
                "Artists' Name: " + jsonData.album.artists[0].name,
                "Song Name: " + jsonData.name,
                "Preview URL: " + jsonData.album.external_urls.spotify,
                "Album: " + jsonData.album.name
            ].join("\n\n");

            writeToLogs(songData, function (err) {
                if (err) throw err;
